...
using SchoolExercise.ViewsModel;
...
namespace SchoolExercise.Controllers
{
    public class StudentsController : Controller
    {
		...
		public ActionResult EnrolledsForStudents(int? id) {
			EnrolledsForStudents enrolledsForStudents = new EnrolledsForStudents();
			var student = db.Students.Find(id);
			var classes = db.Enrolleds.Where(o => o.StudentId == id);
			enrolledsForStudents.Student = student;
			enrolledsForStudents.Enrolleds = classes;
			return View(enrolledsForStudents);
		}
